...
**The Legal AI Architect** | Head of Legal Innovation @ [Ruli AI](https://ruli.ai) | Law x Product x AI
...
- [**Legal AI Architect Toolkit**](https://github.com/OneC0de/legal-ai-architect-toolkit) — Prompts, frameworks, and workflows for lawyers building with Claude AI
- [**Knowledge Work Plugins**](https://github.com/OneC0de/knowledge-work-plugins) — Plugins for knowledge workers using Claude (forked from Anthropic)

## Writing & ideas

I write about legal AI, institutional memory, and the future of legal work on [LinkedIn](https://www.linkedin.com/in/donnascaffidi/).
